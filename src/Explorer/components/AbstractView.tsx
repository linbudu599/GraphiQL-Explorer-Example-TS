// @ts-nocheck
import { InlineFragmentNode, DocumentNode } from "graphql";
import React from "react";
import { AbstractViewProps, Selections } from "../types";
import { Checkbox } from "../utils";
import FieldView from "./FieldView";

export default class AbstractView extends React.PureComponent<
  AbstractViewProps,
  {}
> {
